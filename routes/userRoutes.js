 ...
 */
router.delete('/:id', userMiddleware.checkIfUserToken, userMiddleware.checkIfUserIsAmployee,userMiddleware.validateUserId(Validator.userIdSchema), userController.deleteUserById)
